...
test('place research includes news from descendants but not unrelated locations', () => {
  ...
  const news = relatedLocationNews([
    { title: 'Новость Исфары', description: 'Факт', sourceName: 'Факты', url: 'https://example.test/1', publishedAt: '2026-08-17T00:00:00Z', category: 'Новости', geolocationThreshold: 0.78, locations: [{ locationId: 'city-isfara', confidence: 0.9 }] },
